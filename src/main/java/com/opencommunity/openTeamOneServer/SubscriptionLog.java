...
interface SubscriptionLogRepository extends CrudRepository<SubscriptionLog, SubscriptionKey> {
}
...
public class SubscriptionLog {
	...
	public SubscriptionLog(JSONObject item) throws JSONException {
	...
	public static Iterable<SubscriptionLog> fromJsonArray(JSONArray array) throws JSONException {
		if (array == null)
			return null;
		ArrayList<SubscriptionLog> subscriptionLogList = new ArrayList<>();
		for (int i = 0; i < array.length(); i++)
			subscriptionLogList.add(new SubscriptionLog(array.getJSONObject(i)));
		return subscriptionLogList;
	}

	public static JSONArray toJsonArray(Iterable<SubscriptionLog> subscriptionLogs) throws JSONException {
		JSONArray array = new JSONArray();
		for (SubscriptionLog subscriptionLog : subscriptionLogs)
			array.put(subscriptionLog.toJson());
		return array;
	}
